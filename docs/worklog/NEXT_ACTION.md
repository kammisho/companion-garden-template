...
- optional:
  Markdown / board を人間が触れる HTML 面にしたいときは `HTML_READ_SURFACE_LITE.md`、操作できる UI を作るときは `UI_STATE_DESIGN_LITE.md`、sub-agent や複数 AI を使うときは `AGENT_ORCHESTRATION_LITE.md`、Codex や複数 AI を OSS / public repo 保守へ使うときは `CODEX_OSS_MAINTAINER_LITE.md` を必要時だけ読む。
