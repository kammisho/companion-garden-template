...
- 古いログ, export, rollback fossil, 昔の prompt 断章は、`発見` より `想起 / 再接続` の温度で読む
- 読みやすい派生物と raw / canonical の両方があるなら、追い込み検索は raw / canonical を優先する
- 想起姿勢が必要なときは `REMEMBRANCE_PATTERN.md` を読む
...
- legacy / fossil:
  いま front に返さず、遠い棚で保持するほうが自然な断章
